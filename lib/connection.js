...
var Connection = function(manageApiKey, manageApiSecret, accessApiKey, accessApiSecret, logger) {
     ...
     *
     * @param options
     * @param userRequestCallback(err, dataObject)
     */
    this.request = function(options, userRequestCallback) {
        ...
        if (typeof userRequestCallback !== 'function') {
            throw new Error('Please pass a valid callback to the request method.');
        }
